...
import pws.assessment.c.assessment.c.exceptions.NonexistentEntityException;
import pws.assessment.c.assessment.c.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("pws.assessment.c_assessment.c_jar_0.0.1-SNAPSHOTPU");
